  ...
  try {
    ...
    if (reviewId.value) {
      ...
      const response = await axios.get(
        `http://localhost:3002/api/reviewer/viewreview/${reviewId.value}`,
        {
...
const saveAsDraft = async () => {
  ...
  try {
    ...
    if (reviewId.value) {
      ...
      // ✅ 使用正确的API路径
      response = await axios.post('http://localhost:3002/api/reviewer/viewreview', dataToSave, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
  ...
  try {
    ...
    if (reviewId.value) {
      ...
      response = await axios.post(
        `http://localhost:3002/api/reviewer/viewreview/${reviewId.value}/submit`,
        dataToSubmit,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      response = await axios.post('http://localhost:3002/api/reviewer/viewreview', createData, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
