    ...
    <div class="dashboard-content">
      ...
      <aside class="sidebar" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
        ...
        <nav class="sidebar-nav">
          ...
          <div class="nav-section">
            <h4 v-if="!sidebarCollapsed" class="nav-section-title">系统配置</h4>
            <router-link to="/admin/system" class="nav-link" active-class="active">
              <span class="nav-icon">⚙️</span>
              <span v-if="!sidebarCollapsed" class="nav-text">系统设置</span>
            </router-link>
            <router-link to="/admin/backup" class="nav-link" active-class="active">
              <span class="nav-icon">💾</span>
              <span v-if="!sidebarCollapsed" class="nav-text">数据备份</span>
            </router-link>
          ...
          <div class="nav-section">
            <h4 v-if="!sidebarCollapsed" class="nav-section-title">数据统计</h4>
            ...
            <router-link to="/admin/reports" class="nav-link" active-class="active">
              <span class="nav-icon">📈</span>
              <span v-if="!sidebarCollapsed" class="nav-text">报表管理</span>
            </router-link>
          </div>

          <div class="nav-section">
            <h4 v-if="!sidebarCollapsed" class="nav-section-title">运维监控</h4>
            <router-link to="/admin/monitor" class="nav-link" active-class="active">
              <span class="nav-icon">📡</span>
              <span v-if="!sidebarCollapsed" class="nav-text">系统监控</span>
            </router-link>
            <router-link to="/admin/performance" class="nav-link" active-class="active">
              <span class="nav-icon">⚡</span>
              <span v-if="!sidebarCollapsed" class="nav-text">性能分析</span>
            </router-link>
          </div>
        </nav>
